function KinectRecord = f_importCSV(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   KINECTRECORD = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   KINECTRECORD = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   KinectRecord = importfile('KinectRecord.csv', 3, 333);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2019/07/08 19:23:48
