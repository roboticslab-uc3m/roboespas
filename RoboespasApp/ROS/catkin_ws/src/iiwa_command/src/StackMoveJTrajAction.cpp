...
class StackMoveJTrajAction
{
    ...
    as(nh, name, boost::bind(&StackMoveJTrajAction::callback_MoveJTraj, this, _1), false) //Create the action server
    {
        as.start();
        ...
        q_sub = nh.subscribe("/iiwa/state/JointPosition", 1000, &StackMoveJTrajAction::callback_qSub, this);
        qdot_sub = nh.subscribe("/iiwa/state/JointVelocity", 1000, &StackMoveJTrajAction::callback_qdotSub, this);
        qtorque_sub = nh.subscribe("/iiwa/state/JointTorque", 1000, &StackMoveJTrajAction::callback_qtorqueSub, this);
