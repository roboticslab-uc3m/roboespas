...
close all;
init_ros;
rosparam('set', '/iiwa_command/control_step_size', 0.1);
...
[traj_comm, traj_out] = IiwaCommandStack.MoveJTraj(traj_spline);
...
%Produces not-smooth output if captured velocity and output velocity are
%not the same. 
