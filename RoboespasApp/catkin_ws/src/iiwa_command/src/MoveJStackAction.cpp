...
class MoveJStackAction
{
    ...
    MoveJStackAction(std::string name) :
    as(nh, name, boost::bind(&MoveJStackAction::callback_MoveJ, this, _1), false) //Create the action server
    {
        as.start();
        ...
        q_sub = nh.subscribe("/iiwa/state/JointPosition", 1000, &MoveJStackAction::callback_qSub, this);
        qdot_sub = nh.subscribe("/iiwa/state/JointVelocity", 1000, &MoveJStackAction::callback_qdotSub, this);
        qtorque_sub = nh.subscribe("/iiwa/state/JointTorque", 1000, &MoveJStackAction::callback_qtorqueSub, this);
    }
