...
#ifndef OPENSIM_SPASTIC_MUSCLE_H_
#define OPENSIM_SPASTIC_MUSCLE_H_
/* -------------------------------------------------------------------------- *
 *                        OpenSim:  SpasticThelenMuscleModel.h                         *
 * -------------------------------------------------------------------------- *
...
namespace OpenSim {
	...
	/**
	 */
	class OSIMPLUGIN_API SpasticThelenMuscleModel : public Thelen2003Muscle
	{
		OpenSim_DECLARE_CONCRETE_OBJECT(SpasticThelenMuscleModel, Thelen2003Muscle);
	public:
		//=============================================================================
		// PROPERTIES
		//=============================================================================
	...
	public:
		...
		//=============================================================================
			...
			// CONSTRUCTION
			//-------------------------------------------------------------------------
		SpasticThelenMuscleModel();
		SpasticThelenMuscleModel(const std::string &name, double maxIsometricForce,
	...
	protected:
		...
		//void SpasticThelenMuscleModel::computeMuscleExcitation(SimTK::State& s);// const override;
		//void SpasticThelenMuscleModel::computeControls(const SimTK::State& s, SimTK::Vector &controls) const;
		double SpasticThelenMuscleModel::calcActivationRate(const SimTK::State& s) const override;
